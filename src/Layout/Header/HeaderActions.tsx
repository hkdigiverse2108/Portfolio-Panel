 ...
 const handleChangePassword = () => {
  ...
  return (
    <div className="flex items-center gap-2 sm:gap-4">
      ...
      {/* Profile Dropdown */}
      <button onClick={handleClick} className="flex items-center gap-2 p-0.5 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors ml-1">
        <Avatar alt="Admin User" src="https://avatars.githubusercontent.com/u/1?v=4" sx={{ width: 36, height: 36 }} className="border-2 border-white! dark:border-gray-700! shadow-sm" />
      </button>
      ...
      >
        ...
        <MenuItem onClick={handleChangePassword} className="!py-2.5 !text-sm dark:text-gray-200 dark:hover:bg-gray-800/50">
          <ListItemIcon>
